                        ...
                        <table cellpadding='0' cellspacing='0' border='0' width='88%' style='width: 88% !important; min-width: 88%; max-width: 88%;'>
                            ...
                            <td align='left' valign='top'>
                                <font face=''Source Sans Pro', sans-serif' color='#1a1a1a' style='font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;'>
                                    <span style='font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;'>Hey {{$user->name}},</span>
                                </font>
                                <div style='height: 33px; line-height: 33px; font-size: 31px;'>&nbsp;</div>
                                <font face=''Source Sans Pro', sans-serif' color='#585858' style='font-size: 24px; line-height: 32px;'>
                                    <span style='font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;'>La empresa {{ $uempresa->name }} acaba de crear una cuenta a tu nombre en nuestro sistema.</span>
                                </font>
